// Fork of https://www.npmjs.com/package/node-readfiles
// Adding exclude option to exclude files based on regexes.
// This exclusion must be done here to avoid having many open files at the same time.
'use strict';
        ...
        (function next() {
          ...
          fs.stat(fullpath, function (err, stat) {
            ...
            if (stat.isDirectory()) {
              ...
              if (options.exclude && isExcludeFilename('/' + relFilename, options.exclude)) {
                return next();
              }
